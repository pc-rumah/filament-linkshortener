        ...
        <div class="pricing-cards">
            ...
            <div class="card card-pro">
                ...
                <div class="card-footer">
                    ...
                    @else
                        <button class="btn btn-pro" disabled>
                            <span class="btn-text">Sudah di paket ini</span>
                            <svg class="btn-arrow" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd"
                                    d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z"
                                    clip-rule="evenodd" />
        ...
        document.getElementById('pay-pro').addEventListener('click', function() {
            ...
            fetch('/billing/pay', {
                ...
                .finally(() => {
                    btn.disabled = false;
                    btn.innerHTML =
                        '<span class="btn-text">Upgrade to Pro</span><svg class="btn-arrow" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>';
                });
        });
    </script>
@endsection
